...
public class NewJFrame extends javax.swing.JFrame {
    ...
    if (selectedRow == -1) {
        JOptionPane.showMessageDialog(this, "Выберите строку для расчёта!", 
    ...
    try {
        ...
        // Читаем значения из выделенной строки
        ...
        // === ВЫЗОВ МНОГОПОТОЧНОГО РАСЧЁТА ===
        double result = newRecord.calculateIntegralParallel6Threads();
        ...
        model.setValueAt(String.format(Locale.US, "%.6f", result), selectedRow, 3);
        ...
        JOptionPane.showMessageDialog(this, "Некорректные числовые данные!", "Ошибка формата", JOptionPane.ERROR_MESSAGE);
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        model.setValueAt("Ошибка", selectedRow, 3);
    } catch (Exception ex) {
        logger.log(java.util.logging.Level.SEVERE, "Ошибка расчёта", ex);
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        model.setValueAt("Ошибка", selectedRow, 3);
    }
